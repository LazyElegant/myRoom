...
<html>
	...
	<body>
		...
		<div class="mauto" style="width: 1366px;padding-bottom: 20px;">
			<div class="clearfix">
				<div id="Model">
					<form method="post" action="/updateHotel" style="text-align: center">
						<input type="text" style="display: none" name="id" value="${hotel.getId()}">
						<h3>酒店名</h3>
						<input name="name" value="${hotel.getName()}" class="form-control" type="text" id="btn">
						<h3>酒店地址</h3>
						<input name="address" value="${hotel.getAddress()}" class="form-control" type="text">
						<h3>酒店负责人</h3>
						<input name="principal" value="${hotel.getPrincipal()}" class="form-control" type="text">
						<h3>负责人电话</h3>
						<input name="phone" value="${hotel.getPhone()}" class="form-control" type="text">
						<br>
