		...
		<div class="mauto" style="width: 1166px;padding-bottom: 20px;">
			<div class="clearfix">
				<ul id="left_nav" class="fl-left bgfff">
					<li class="c_menu">
						<a href="javascript:;" id="grzx">添加食材</a>
					</li>
					<li class="c_menu">
				...
				<div id="Model" class="fl-right">
					<div id="content2" class="thiscontent" style="background-color: #fff;border-top: 3px solid #8B3734;padding: 20px;padding-bottom:0;min-height: 409px;">
						...
						<form method="post" action="/updateFoods">
							<input type="text" style="display: none" name="id" value="${foods.getId()}">
							<h3>食材名</h3>
							<input value="${foods.getName()}" style="width: 400px;height: 40px;line-height: 40px;margin-left: 15px;" name="name" class="form-control" type="text" id="btn">
							<h3>食材数量（千克）</h3>
							<input value="${foods.getCount()}" style="width: 400px;height: 40px;line-height: 40px;margin-left: 15px;" name="count" class="form-control" type="text">
							<h3>食材详情</h3>
							<textarea name="content" style="width: 800px;height: 300px;resize:none;font-size: 18px;padding: 10px;">${foods.getContent()}</textarea>
							<br>
