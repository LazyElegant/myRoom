		...
		<div class="mauto" style="width: 1166px;padding-bottom: 20px;">
			<div class="clearfix">
				<ul id="left_nav" class="fl-left bgfff">
					<li class="c_menu">
						<a href="javascript:;" id="grzx">上架商品</a>
					</li>
					<li class="c_menu">
				...
				<div id="Model" class="fl-right">
					<div id="content2" class="thiscontent" style="background-color: #fff;border-top: 3px solid #8B3734;padding: 20px;padding-bottom:0;min-height: 409px;">
						...
						<form method="post" action="/updateGoods">
							<input type="text" style="display: none" name="id" value="${goods.getId()}">
							<h3>商品名</h3>
							<input value="${goods.getName()}" style="width: 400px;height: 40px;line-height: 40px;margin-left: 15px;" name="name" class="form-control" type="text" id="btn">
							<h3>商品价格</h3>
							<input value="${goods.getPrice()}" style="width: 400px;height: 40px;line-height: 40px;margin-left: 15px;" name="price" class="form-control" type="text">
							<h3>商品详情</h3>
