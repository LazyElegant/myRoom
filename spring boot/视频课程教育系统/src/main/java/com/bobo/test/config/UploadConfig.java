...
public class UploadConfig implements org.springframework.web.servlet.config.annotation.WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/video/**").addResourceLocations("file:///" + relativelyPath + "\\src\\main\\resources\\static\\video\\");
        registry.addResourceHandler("/file/**").addResourceLocations("file:///" + relativelyPath + "\\src\\main\\resources\\static\\file\\");
    }
}