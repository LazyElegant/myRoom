...
public class AdminCourseList {
    public static void App() {
        ...
        try {
            ResultSet app = Sql_Statement_Query.App("SELECT c.id,c.code,c.name,cl.name,t.name FROM course c Left join class cl on cl.code = c.class_code Left join teacher t on t.code = c.teacher_code ");
            while (app.next()) {
